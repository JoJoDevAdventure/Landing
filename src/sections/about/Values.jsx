    ...
    <section ref={sectionRef} className="relative py-0 -mt-48 overflow-visible">
      ...
      <div className="text-center mb-8">
        <motion.p
          ...
          className="caption text-s3"
        >
          Core Values
        </motion.p>
        <motion.h1
          className="h3 mb-0 text-p4"
          initial={{ opacity: 0, y: 20 }}
          animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }}
          transition={{ duration: 1, ease: "easeOut", delay: 0.3 }}
        >
      ...
      >
        ...
        >
          ...
          {[...coreValues, ...coreValues].map((value, index) => (
            <motion.div
              key={index}
              className="relative min-w-[300px] md:min-w-[350px] py-10 border-2 border-s2 rounded-3xl g9 shadow-lg flex flex-col align-center justify-center group"
            >
