...
const What = () => {
  ...
  return (
    <div ref={sectionRef} className="flex flex-col gap-12 items-center">
      ...
      <motion.h1
        className="h3 mb-0 text-p4 text-center max-md:h5"
      ...
      <div className="flex flex-wrap gap-4 items-stretch max-md:flex-col justify-between max-md:mt-42 mt-24">
        {/* Parallax Div 1 */}
        <motion.div
          className="relative w-full md:w-[40%] h-64 flex flex-col items-center justify-center text-white p-6 rounded-lg min-h-[500px]"
          >
